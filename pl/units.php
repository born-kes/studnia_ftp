...
for($i=0; $i<count($id);$i++){
 ...
 $ws_mobile2 = " INSERT INTO ws_mobile SET id='".$_POST['id'][$id[$i]]."', data='$wczasy' ";
...
$sta=status(ile_woja($_POST['wpik'][$pik_r[$i]],
 ...
 $ws_mobile  .= $Wojska_mobilne. " WHERE `id`='".$_POST['id'][$id[$i]]."'; ";
     ...
     destructor();
           ...
           {
 //               $string='Nie Uda³o siê Dodaæ Raportu'; $l++;// echo $string.': '.$ws_raport2."<br>".$ws_raport."<br>";
     ...
     destructor();
    // echo $string.': '.$ws_raport2."<br>".$ws_raport."<br>";
     ...
     destructor();
           ...
           }else{$string='Zaktu³alizowano Raport';$rs++; }
...
$fin = ($licz+$rs)/2-$l;
  ...
  echo ' W sumie '.$licz.'rekordow <b>Wojsko w wiosce</b><br>';
