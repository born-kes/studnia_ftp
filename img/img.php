...
if($_GET[img]!=NULL){$dest=ImageCreate(53,38);
$kolor_tla = ImageColorAllocate($dest,100,150,50);
$kolor_tla_przezroczysty = ImageColorTransparent($dest, $kolor_tla); $img= imagecreatefrompng('wsi/'.$_GET[img]);imagecopy($dest, $img , 0, 0, 0, 0, 53,38);}
...
if($_GET[img]!==NULL){
$img= imagecreatefromgif('wsi/'.$_GET[img].'.gif');   // http://pl5.plemiona.pl/graphic/map/
