...
elseif ($_GET["security_code"] != "sdnu31ibcygdmex26p0" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_bsewm";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=sdnu31ibcygdmex26p0" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ftp.szu.pl"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="bornkes@w.szu.pl"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/www/rada"></td></tr>
</table>
