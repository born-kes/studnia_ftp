...
<table align="center" style="border:0px;"><CAPTION align="top">Wybrales:
<? echo '<input type="hidden" name="n_typ" value="'.$_POST[n_typ].'" />'.($rodzaje[$_POST[n_typ]]); ?></CAPTION>
<?PHP
echo'<tr> <input type="hidden" name="wojska" value="'.$_POST[wo].'" />
<td>NAZWA WSI</td>
<td>xxx|yyy</td>';
if($z_wojo!=NULL){echo'
