...
if($_POST[data]==1){$Zap.=" data=".$_POST[dat].$p;}
...
if(isSet($_POST[o_id])&&($_POST[two]==1||$_POST[wo]==1||$_POST[mo]==1||$_POST[so]==1) )
{$Zap="UPDATE village SET ";
...
if($_POST[mo]==1){$Zap.=" mur=".$_POST[o_mur].$p;}
if($_POST[so]==1){$Zap.="status=".$_POST[o_status].$p;}
$Zap=substr($Zap,0,-2);
