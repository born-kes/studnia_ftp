...
connection();
      $wynik = mysql_query("SELECT w.id, w.x, w.y, p.id, p.name, a.id, a.tag, w.name, w.points, w.typ, w.data, w.mur, w.pik, w.mie, w.axe, w.luk, w.zw, w.lk, w.kl, w.ck, w.tar, w.kat, w.ry, w.sz, w.opis
...
if($r[12]!==NULL){$o6[0]=$r[12];}else{$o6[0]="' '";}//pik
if($r[13]!==NULL){$o6[1]=$r[13];}else{$o6[1]="' '";}//mie
if($r[14]!==NULL){$o6[2]=$r[14];}else{$o6[2]="' '";}//axe
if($r[15]!==NULL){$o6[3]=$r[15];}else{$o6[3]="' '";}//luk
if($r[16]!==NULL){$o6[4]=$r[16];}else{$o6[4]="' '";}//zw
if($r[17]!==NULL){$o6[5]=$r[17];}else{$o6[5]="' '";}//LK
if($r[18]!==NULL){$o6[6]=$r[18];}else{$o6[6]="' '";}//kl
if($r[19]!==NULL){$o6[7]=$r[19];}else{$o6[7]="' '";}//ck
if($r[20]!==NULL){$o6[8]=$r[20];}else{$o6[8]="' '";}//tar
if($r[21]!==NULL){$o6[9]=$r[21];}else{$o6[9]="' '";}//kat
if($r[22]!==NULL){$o6[10]=$r[22];}else{$o6[10]="' '";}//ry
if($r[23]!==NULL){$o6[11]=$r[23];}else{$o6[11]="' '";}//sz		//wojsko
