...
if(strpos($mur,"obronny")!== false){$nev_mur=intval(substr($mur,strrpos($mur," ")));}elseif(strpos($mur,"uszkodzony")!== false){$nev_mur=substr($mur,-2);}
...
echo"<big>Uchwyty wylapaly</big><br><br>
<b>Data:</b> $nev_data[0], $nev_data[1], $nev_data[2] <br>
<b>wioske o </b>x:$nev_wioska[0]|<b>y:</b>$nev_wioska[1]<br><br>
<b>Wojska:</b><br>
...
<b>Rycerz:</b>$nev_wojsko[11],<b> Szlachta:</b> $nev_wojsko[12]<br><BR>";
if($nev_mur!==Null){echo"<b>W wiosce zostal muru na poziomie:</b>$nev_mur";}
?>