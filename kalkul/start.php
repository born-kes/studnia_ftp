...
function pomoc(){
var st = "Radar szuka powiazan miedzy dwoma wioskami.\n Ta w ktorej jestes, a twoimi i tworzy liste\n wedlug czasu dojscia do niej.";
...
<body><div style="position: absolute; top: -6px; left: 70px;"><form name="form" action="radar.php" method="POST">
<?php      sesio_id();
...
$nagluwek = 'Agresor: <b style="color:green;">'.urldecode($user).'</b> Obronca: <b style="color:red;">'.urldecode($obr[2]).'</b> ('.$obr[0].'|'.$obr[1].')';
...
<tr><td colspan="2"><? echo $nagluwek; ?></td></tr>
<tr>
 ...
 <b id="czas0_txt"> Czas:</b>
 <input name="czas1" id="czas1" value="4" size="13" type="text" onclick="show_calendar('document.form.czas1',document.form.czas1.value,false);" style="border-bottom:0px;">
 <b id="czas1_txt"></b>
<a href="javascript:show_calendar('document.form.czas1',document.form.czas1.value,false);"><img src="../img/cal.gif" border="0" height="16" width="16" alt="Clicknij Tu by ustaliæ Datê"></a>
 <a href="javascript:pomoc();">?</a></td>
</tr>

<tr><td valign="top"><b>Wojska maja dotra na podana godzine?</b><br />
<input name="on" value="0" type="radio" checked="tak">Nie, pokaz tez te ktore dojda wczesniej <br />
<input name="on" value="1" type="radio">Tak, odzuc te ktore beda za wczesnie <a href="javascript:ukryj('inne_time')" class="red">*</a><br />
</td></tr>
...
function test()
{      var ile = document.getElementById("czas1").value; var str0='';var str1='';
if( ile.indexOf(' ')>-1 &&  ile.indexOf('.')>-1 &&  ile.indexOf(':')>-1 ){str0='do dnia'; str1 = 'godziny';}
if( ile.indexOf('.')>-1 ){ str0 = 'do dnia'; }
else if( ile.indexOf(':')>-1 ){ str0 = 'do godziny'; }//godzina
else{str0='do'; str1 = 'godzin';}

      document.getElementById("czas0_txt").innerHTML = str0;
      document.getElementById("czas1_txt").innerHTML = str1;
