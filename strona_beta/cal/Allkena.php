...
<body>
Kalkulator Allkena<br />
                           <br /><form enctype="multipart/form-data" action="" method="post">
  <table>
    <tr>
      <td>Wioska xxx | yyy którą atakujesz</td><td><input type="text" name="xy_wsi" maxlength="7" size="10" alt=""value="<?PHP
 if($_POST[xy_wsi]==NULL){echo'';}else{echo $_POST[xy_wsi];} ?>"><BR /></td>
    </tr>
    <tr>
      <td>Gracz - ty ? </td><td><input type="text" name="gracz" size="10" alt=""  value="<?PHP
 if($_POST[gracz]==NULL){echo'';}else{echo $_POST[gracz];} ?>"></td>
    </tr>
    <tr>

      <td>Okolica z której atakujesz xxx | yyy </td><td><input type="text" name="xy_okolica" maxlength="7" size="10" alt="" value="<?PHP
...
?>"></td>
 ...
 if($_POST[godz]==NULL){echo date("G:i:s");}else{echo $_POST[godz];} ?>"></td>
  ...
  </table><input value="Dalej" type="submit"></form>
</body>
</html>
