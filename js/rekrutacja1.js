...
(function(){
	...
	var lang = {
		...
		'de': {
			...
			'settoobig': 'Die Einstellungen für die Massenrekrutierung sind zu gro�&#65533; um in einem Cookie gespeichert zu werden. Es kann daher zu Problemen kommen. Das Löschen einiger Gruppen kann das Problem lösen.'
		}
	};
	...
	// get available units
	var units = [];
	var u = $x('table/thead/tr/th/img[contains(@src,"unit_")]', recform[0]);
