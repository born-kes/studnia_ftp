// ==UserScript==
// @name           Masowa Rekrutacja
// @description    Zaawansowana masowa rekrutacja
// @author         Michael Richter
// @namespace      http://osor.de/
// @include        http://de*.die-staemme.de/game.php?*mode=mass*
// @include        http://ch*.staemme.ch/game.php?*mode=mass*
// @include        http://en*.tribalwars.net/game.php?*mode=mass*
// @include        http://pl*.plemiona.pl/game.php?*screen=train&mode=mass*
// ==/UserScript==
...
(function(){
	...
	if(!/mode=mass/.test(location.href) || !/screen=train/.test(location.href)) {
		return;
	}
	...
	var lang = {
		'en': {
			...
			'troupsize': 'Oczekiwany uk³ad wojsk',
			'troupsizedesc': 'Wpisz tutaj, jaka ma byæ ilo¶æ poszczególnych wojsk w momencie zape³nienia zagrody',
			'openend': 'Buduj dalej:',
			'openenddesc': 'Zaznaczanie sprawia, ¿e dana jednostka bêdzie budowana dalej, je¶li w zagrodzie bêd± miejsca',
			'farmfree': 'Ile miejsc w zagrodzie pozostawiæ wolnych?',
			'farmfreedesc': 'Np. 100 dla szlachchica',
			'resfree': 'Ile surowców pozostawiæ w wiosce:',
			'resfreedesc': 'Ile surowców skrypt ma pozostawiæ w wiosce',
			'save': 'Zapisz',
			'fill': 'Wype³nij',
			'recruit': 'Rekrutuj',
			'running': 'Obliczanie...',
			'troupneeds': '(Oczekiwany uk³ad wojsk wymaga %1 miejsc w zagrodzie)',
			'filled': 'Wype³niono: %1 w %2 wioskach',
