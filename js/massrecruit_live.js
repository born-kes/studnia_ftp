function myMassRecruit(xmlConfig){
	...
	try {var arrLang=location.hostname.split('.');
		 ...
		 if(strLang=='ru')strVillage='Ð&#65533;ÐµÑ&#65533;ÐµÐ²Ð½Ñ&#65533;';
		}
	catch(objError){}
...
/*		}*/
	...
	function myGetGroup(){
		try{return myInt(eleDoc.getElementById('menu_row2').cells[4].getElementsByTagName('a')[0].href.match(/\bgroup_id=(\d+)/)[1]);}
...
/*		strMessage='Input changed:\n';
	...
	var intRow=0;
	fnStatus('Started');
	var strGroup=arrTables[intTable-2].rows[0].cells[1].innerHTML.match(/[>|&gt;]([^>;]+?)&lt;/)[1];
