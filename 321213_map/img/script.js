...
function map_popup(title, points, owner, ally, mur, pik, mie, axe, ar, zw, lk, kar, ck, tar, kat, ry, sz, opis, data) {
	...
	if(ally != null) {
		gid("info_ally").style.display = '';
		setText(gid("info_ally"), ally);
	}
	else {
		gid("info_ally").style.display = 'none';
	}
